	...
	<div id="div_<c:out value="${map.queue.queueId}"/>" class="col-sm-6 col-md-3" style="display: block;">
		<div class="thumbnail">
			...
			<div class="caption">
				...
				<input type="hidden" id="input_map_userAccountId" value="<c:out value="${map.queue.user.userId}"/>">
			...
			<div class="modal-content">
				<div class="modal-body">
					<div class="jumbotron">
						...
						<p><c:out value="${map.queue.dscr}" escapeXml="false"/><br/><br/></p>
						<p><%@include file="/jsp/queue_star.jsp" %></p>
						<p><%@include file="/jsp/queue_count.jsp" %></p>
					</div>
					<div class="row">
						...
						<div class="col-xs-6 col-lg-4">
							...
							<p>
								<span id="span_address"><c:out value="${map.queue.address}"/>&nbsp;<a href="http://maps.google.com.tw/maps?f=q&hl=zh-TW&geocode=&q=<c:out value="${map.queue.address}"/>&z=16&output=&t=" target="_blank"><i class="fa fa-map-marker"></i></a></span>
						...
						<div class="col-xs-6 col-lg-4">
							<h2><i class="fa fa-users"></i>&nbsp;<c:out value="${map.queuingCount}"/></h2>
						</div>
						<div class="col-xs-6 col-lg-4">
							<h2><i class="fa fa-clock-o"></i>&nbsp;<c:out value="${map.avgWaittingTime}"/></h2>
						</div>
						<div class="col-xs-6 col-lg-4">
							<h2><i class="fa fa-list-ol"></i>&nbsp;<span id="span_queueNum" class="label label-default"><c:out value="${map.queueNum}"/></span></h2>
						</div>
						</c:if>
